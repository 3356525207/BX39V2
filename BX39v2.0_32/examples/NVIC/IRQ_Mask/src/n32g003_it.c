...
/**
*\*\name    EXTI0_1_IRQHandler.
*\*\fun     This function handles EXTI1 exception.
*\*\param   none
*\*\return  none 
**/
...
{
    printf("EXTI11 IRQHandler Start \r\n");
    if (EXTI_Flag_Status_Get(KEY_INPUT_EXTI_LINE) != RESET)
    {
    ...
    log_info("EXTI11 IRQHandler End \r\n");
}

/**
*\*\name    TIM3_IRQHandler.
*\*\fun     This function handles TIM3 exception.
*\*\param   none
*\*\return  none 
**/
void TIM3_IRQHandler(void)
{
    ...
    TIM_Flag_Clear(TIM3, TIM_INT_UPDATE);
