...
static void SPI_RCC_Configuration(void)
{
	...
	/* Enable SPI_SCK Port Clock */
	RCC_APB_Peripheral_Clock_Enable(SPI_Slave_SCK_CLK);
	
	/* Enable SPI_MOSI and SPI_MISO Port Clock */
	RCC_APB_Peripheral_Clock_Enable(SPI_Slave_MOSI_CLK);
}
...
static void SPI_GPIO_Configuration(void)
{
	...
	/* Configure Slave Pins MOSI as Input-floating */
