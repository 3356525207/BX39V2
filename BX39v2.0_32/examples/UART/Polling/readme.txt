1、功能说明
    ...
    首先，UARTy发送TxBuffer1数据至UARTz，UARTz接收数据存至RxBuffer1。比较接收数据与发送数据，比较结果存入TransferStatus1变量。
    随后，UARTz发送TxBuffer2数据至UARTy，UARTy接收数据存至RxBuffer2。比较接收数据与发送数据，比较结果存入TransferStatus2变量。
